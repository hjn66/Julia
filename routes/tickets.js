...
router.post(
  ...
  (req, res, next) => {
    ...
    newTicket.save(function(err) {
      ...
      res.json({
        success: true,
        msg: "Ticket Number " + newTicket.ticketNumber + " Created"
      });
    });
  }
);
  ...
  (req, res, next) => {
    ...
    Ticket.getTicketByNumber(ticketNumber, (err, ticket) => {
      ...
      if (ticket.userEmail != userEmail) {
        Log(
          "Method: CancelTicket, Error: User can not cancel others' ticket",
          req.user.email
        );
        ...
        ticket.save(function(err) {
          ...
          res.json({
            success: true,
            msg: "Ticket Number(" + ticketNumber + ") Canceled Successfuly"
          });
        });
      }
    });
...
router.post(
  ...
  (req, res, next) => {
    ...
    Ticket.getTicketByNumber(ticketNumber, (err, ticket) => {
      ...
      if (ticket.userEmail != userEmail) {
        Log(
          "Method: ResolveTicket, Error: User can not resolve others' ticket",
          req.user.email
        );
        res.json({
          success: false,
          msg: "User can not resolve others' ticket"
        });
      } else {
        ...
        ticket.save(function(err) {
          ...
          res.json({
            success: true,
            msg: "Ticket Number(" + ticketNumber + ") Closed Successfuly"
          });
        });
      }
    });
...
router.post(
  ...
  (req, res, next) => {
    ...
    Ticket.getTicketByNumber(ticketNumber, (err, ticket) => {
      ...
      if (ticket.userEmail != userEmail) {
        Log(
          "Method: ReplayTicket, Error: User can not replay others' ticket",
          req.user.email
        );
        ...
        ticket.save(function(err) {
          ...
          res.json({
            success: true,
            msg: "Ticket Number(" + ticketNumber + ") Replayed Successfuly"
          });
        });
      }
    });
  ...
  (req, res, next) => {
    ...
    Ticket.getTicketByNumber(ticketNumber, (err, ticket) => {
      ...
      User.hasRole(roles, ["admin", "canAnswerTicket"], hasRole => {
        if (!hasRole) {
          Log(
            "Method: AnswerTicket, Error: User has not permission to answer tickets",
            req.user.email
          );
          ...
          ticket.save(function(err) {
            ...
            if (ticket.recieveEmail) {
              ...
              Email.sendMail(
                ticket.userEmail,
                "Your ticket answered",
                mailContent,
                (error, info) => {
                  if (error) {
                    Log(
                      "Method: AnswerTicket, Error: " +
                        err +
                    ...
                    Log(
                      "Method: AnswerTicket, Info: Answer Ticket Email sent to " +
                        ticket.userEmail,
                      req.user.email
                    );
                  }
            ...
            res.json({
              success: true,
              msg: "Ticket Number(" + ticketNumber + ") Answered Successfuly"
            });
          });
        }
      });
...
router.get(
  ...
  (req, res, next) => {
    ...
    User.hasRole(roles, ["admin", "canAnswerTicket"], hasRole => {
      if (!hasRole) {
        Log(
          "Method: ListAllTicketByAdmin, Error: User has not permission to list all tickets",
          req.user.email
        );
        return res.sendStatus(401);
      } else {
...
router.get(
  ...
  (req, res, next) => {
    ...
    User.hasRole(roles, ["admin", "canAnswerTicket"], hasRole => {
      if (!hasRole) {
        Log(
          "Method: ListAllOpenTicketByAdmin, Error: User has not permission to list all tickets",
          req.user.email
        );
        return res.sendStatus(401);
      } else {
